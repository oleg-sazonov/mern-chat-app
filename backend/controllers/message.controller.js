 ...
 *
 * How it works:
 *   1. Finds the conversation between the sender and receiver.
 ...
 *
 * Note:
 *   .populate("messages") is a Mongoose method that automatically fetches and replaces
 *   the message IDs in the conversation with the corresponding message documents,
